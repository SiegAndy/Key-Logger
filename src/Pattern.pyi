...
class Repeat(stringifyable):
    ...
    @overload
    def __init__(self, stop_counter: int, start_key: str = "f10", stop_key: str = "f11") -> None: ...
    @overload
    def __init__(self, stop_counter: int, start_counter: int = 0, step: int = 1, start_key: str = "f10", stop_key: str = "f11") -> None: ...
    @overload
    def __init__(self, sec: float, min: int = 0, hr: int = 0, start_key: str = "f10", stop_key: str = "f11") -> None: ...

class Pattern(stringifyable):

    def __init__(self, name: str, repeat: Repeat = None, key_comb: KeyCombination = None) -> None: ...
